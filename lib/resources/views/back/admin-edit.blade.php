            ...
            <form role="form" action="{{url('/admin/update')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="您的姓名" value="{{$USER->name}}" readonly>
                    </div>
                    <div class="form-group">
                        <label for="nickname">您的暱稱</label>
                        <input type="text" class="form-control" id="nickname" name="nickname" placeholder="暱稱" value="{{$USER->nickname}}" readonly>
                    </div>
                    <div class="form-group">
